...
displayArray(filledIntArray, " filledInt Array" );
...
System.out.println(" not found in intArray");
}

location = Arrays.binarySearch(intArray, 8763);

if (location >= 0) {
	System.out.printf("Found 8763 at element %d found in intArray", location);
}
else{ 
